...
$(function () {
  ...
  parallaxShowCase = new Swiper(
    ".showcase-full .parallax-slider-full",
  ...
  var swiper = new Swiper(".testim-style1 .swiper-container", {
    slidesPerView: 1,
    spaceBetween: 30,
    speed: 1500,
    pagination: {
  ...
  var swiper = new Swiper(".testim-style3 .testim-slider", {
    slidesPerView: 1,
    spaceBetween: 30,
    speed: 1500,
    pagination: {
  ...
  var swiper = new Swiper(".team-style1 .swiper-container", {
    slidesPerView: 3,
    spaceBetween: 50,
    speed: 1500,
    pagination: {
      el: ".team-style1 .swiper-pagination",
      type: "fraction",
    },
    navigation: {
      nextEl: ".team-style1 .swiper-button-next",
      prevEl: ".team-style1 .swiper-button-prev",
    },
    mousewheel: false,
    keyboard: true,
    autoplay: {
  ...
  var swiper = new Swiper(".portfolio-style3 .swiper-container", {
    slidesPerView: 3,
    spaceBetween: 50,
    speed: 1500,
    pagination: {
      el: ".portfolio-style3 .swiper-pagination",
      type: "fraction",
    },
    navigation: {
      nextEl: ".portfolio-style3 .swiper-button-next",
      prevEl: ".portfolio-style3 .swiper-button-prev",
    },
    mousewheel: false,
    keyboard: true,
    autoplay: {
  ...
  var swiper = new Swiper(".testim-style2 .swiper-container", {
    slidesPerView: 1,
    spaceBetween: 30,
    speed: 1500,
    pagination: {
    ...
    navigation: {
      nextEl: ".testim-style2 .swiper-button-next",
      prevEl: ".testim-style2 .swiper-button-prev",
    },
    mousewheel: false,
    keyboard: true,
    autoplay: {
  ...
  var swiper = new Swiper(".blog-style1 .swiper-container", {
    slidesPerView: 2,
    spaceBetween: 60,
    speed: 1500,
    pagination: {
  ...
  $(".services-style2 .item").mouseenter(function () {
    $(".tags", this).slideDown();
  });

  $(".services-style2 .item").mouseleave(function () {
    $(".tags", this).slideUp();
  });

  /* ===============================  Accordion Side  =============================== */

  $(".portfolio-crev").on("click", ".item", function () {
    $(this).addClass("active").siblings().removeClass("active");
  });

  /* ===============================  Brands  =============================== */

  var equalWidth = $(".clients-style1 .item").outerWidth();

  $(".clients-style1 .item").css({
    height: equalWidth,
  });
